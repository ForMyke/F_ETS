...
class FilterSheet extends StatefulWidget {
  ...
  final void Function(String? carrera, int? semestre) onApply;
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            children: widget.carreras.map((c) {
              ...
              return GestureDetector(
                onTap: () => setState(() => _carrera = isSelected ? null : c),
          ...
          Wrap(
            spacing: 8,
            runSpacing: 8,
            children: List.generate(9, (i) => i + 1).map((s) {
              final isSelected = _semestre == s;
              return GestureDetector(
                onTap: () => setState(() => _semestre = isSelected ? null : s),
                child: AnimatedContainer(
                  duration: 200.ms,
                  width: 44,
                  height: 44,
          ...
          GestureDetector(
            onTap: () {
              ...
              widget.onApply(_carrera, _semestre);
            },
            child: Container(
