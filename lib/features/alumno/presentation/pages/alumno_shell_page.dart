...
class AlumnoShellPage extends StatefulWidget {
  ...
  const AlumnoShellPage({super.key, required this.perfil});

  @override
  State<AlumnoShellPage> createState() => _AlumnoShellPageState();
}

class _AlumnoShellPageState extends State<AlumnoShellPage> {
  int _currentIndex = 0;
  late final AlumnoBloc _alumnoBloc;
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider.value(
      ...
      child: Builder(
        builder: (context) {
          final pages = [
            AlumnoExamsPage(perfil: widget.perfil),
            AlumnoInscripcionesPage(perfil: widget.perfil),
          ];
