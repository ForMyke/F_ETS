...
const Map<String, EdificioLocation> campusLocations = {
  ...
  '3': EdificioLocation(
    ...
    lat: 19.504350,
    lng: -99.146300,
    svgOffset: Offset(469, 272),
  ),
  '4': EdificioLocation(
    numeroEdificio: '4',
    nombre: 'Edificio 4 — Salones 2XYZ / 4XYZ',
    lat: 19.504850,
    lng: -99.146300,
    svgOffset: Offset(469, 144),
  ),
  '5': EdificioLocation(
    numeroEdificio: '5',
